  ...
  return (
    <section id="pricing" className="py-20">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Rehoming Plans */}
        <div className="mb-16">
          <h3 className="text-2xl font-bold text-center mb-4">For Rehomers</h3>
          <p className="text-sm text-muted-foreground max-w-3xl mx-auto text-center mb-8">
              ...
              >
                ...
                <CardContent>
                  ...
                  <Button 
                    className="w-full" 
                    variant={plan.popular ? "hero" : "default"}
                    onClick={() => handleSubscribeClick("rehoming")}
                    disabled={isCurrentSubscription("rehoming")}
                  >
                    {getButtonText("rehoming")}
                  </Button>
                </CardContent>
              </Card>
            ))}
        ...
        {/* Multi-Plan */}
        <div className="mb-16">
          <h3 className="text-2xl font-bold text-center mb-4">For Buyers, Breeders, and Rehomers</h3>
          <p className="text-sm text-muted-foreground max-w-3xl mx-auto text-center mb-8">
